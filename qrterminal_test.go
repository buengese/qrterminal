...
func TestGenerate(t *testing.T) {
	Generate("https://github.com/buengese/qrterminal", L, os.Stdout)
}
...
func TestGenerateWithConfig(t *testing.T) {
	...
	GenerateWithConfig("https://github.com/buengese/qrterminal", config)
}

func TestGenerateHalfBlock(t *testing.T) {
	GenerateHalfBlock("https://github.com/buengese/qrterminal", L, os.Stdout)
}
